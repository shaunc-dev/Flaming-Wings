...
<?php
                        ...
                        while ($row = mysqli_fetch_array($r_query)){ 
                          ...
                          echo '<td>  <button type="submit" value='.$row['recipe_id'].' class="btn btn-block btn-default btn-sm" name="ReactivateRecipeButton">Reactivate</button></td>'; 
                          echo "</tr>";
...
?>
                  ...
                  <a href="reactivaterecipe.php">Search Again</a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </form>
