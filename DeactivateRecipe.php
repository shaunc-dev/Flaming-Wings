  ...
  <body class="hold-transition skin-red sidebar-mini">
    ...
    <div class="content-wrapper">
       <section class="content">
        <!-- START OF MODAL -->
          ...
          <form action="SearchDeactivateRecipe.php" method="post" class="sidebar-form">
            <div class="col-xs-10">
            <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"><b>SEARCH RECIPE TO BE DEACTIVATED</b></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="InputStockCode" name="query" placeholder="Enter recipe ID" required>
                      </div>
                    </div>
            ...
            <div class="col-xs-10">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>DEACTIVATE RECIPE</b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                       ...
                       <?php
                        ...
                        while ($row = mysqli_fetch_array($sql)){
                          ...
                          echo "<td>".$row["recipe_name"]."</td>"; //recipe name
                           echo '<td>  <button type="submit" value='.$row['recipe_id'].' class="btn btn-block btn-default btn-sm" name="DeactivateRecipeButton">Deactivate</button>'; 
                          echo "</tr>";
    ...
    $(document).ready(function() {
      $("#DeleteRecipe").on("click", function() {
        console.log($("#DeleteRecipe").data("value"));
      });
    });
