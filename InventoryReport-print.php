            ...
            <table class="table">
              ...
              <tbody>
                <?php
                        ...
                        $sql = mysqli_query($connect, "SELECT stock_id, stock_type, sname, s.qty, unit_name, pack_name FROM stock AS s, stocktype AS type, unitmeasurement AS u, unitpackaging AS pack WHERE s.stocktype_id=type.stocktype_id AND s.unit_id=u.unit_id AND s.pack_id=pack.pack_id AND deactivate= 0 ORDER BY type.stocktype_id ASC");
...
<!--
  ...
  <!--        <div class="col-xs-6">
    ...
    <!--      <div class="col-xs-6">
          ...
          <center>-- END OF INVENTORY REPORT --</center> 
        </div><!-- /.row -->
      </section><!-- /.content -->
    </div><!-- ./wrapper -->
